...
private:
  ...
  struct PerfProcessInfo {
    static constexpr StringLiteral BuildIDEventName = "BUILDIDS";
    static constexpr StringLiteral MainEventName = "MAIN";
    static constexpr StringLiteral MemEventName = "MEM";
    static constexpr StringLiteral MMapEventName = "MMAP";
    static constexpr StringLiteral TaskEventsName = "TASK";
  ...
  ///
  /// perf2bolt will spawn all required perf scripts commands based on the
  /// configuration such as BasicAggregation, LBR, or SPE, to extract all
  /// data and merge them into a single file.
  ///
  /// Generate pre-parsed perf profile for SPE:
  ...
  ///
  /// How the a perf script output looks like:
  ...
  /// Generate pre-parsed perf profile in textual format.
...
inline raw_ostream &operator<<(raw_ostream &OS,
  ...
  switch (T) {
    case DataAggregator::PerfProcessType::BUILDIDS:
      OS << DataAggregator::PerfProcessInfo::BuildIDEventName;
      break;
    case DataAggregator::PerfProcessType::MAIN_EVENTS:
      OS << DataAggregator::PerfProcessInfo::MainEventName;
      break;
    case DataAggregator::PerfProcessType::MEN_EVENTS:
      OS << DataAggregator::PerfProcessInfo::MemEventName;
      break;
    case DataAggregator::PerfProcessType::MMAP_EVENTS:
      OS << DataAggregator::PerfProcessInfo::MMapEventName;
      break;
    case DataAggregator::PerfProcessType::TASK_EVENTS:
      OS << DataAggregator::PerfProcessInfo::TaskEventsName;
      break;
    default:
      llvm_unreachable("unexpected process type");
      break;
  }
  return OS;
}
